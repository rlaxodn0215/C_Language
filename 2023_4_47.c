...
*/
	...
	unsigned int Expext_Life_Min;					//기대 수명을 분으로 환산
	...
	Expext_Life_Min = (100 * Year_To_Day * Day_To_Hour * Hour_To_Min) - ((3 * Hour_To_Min + 40) * M * Year_To_Day * N);
	Ex_min = (Expext_Life_Min % 60);
	Ex_hour = ((Expext_Life_Min / 60) % 24);
	Ex_day = ((Expext_Life_Min / (60 * 24)) % 365);
	Ex_year = (Expext_Life_Min / (365 * 60 * 24));
